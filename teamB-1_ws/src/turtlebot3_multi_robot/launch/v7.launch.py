...
"""
일단 터틀봇 매니퓰레이터 불러오는것까진 됨

근데 rviz에도 맵만뜨고 연동 되지 않음
-> arguments부분을 바꿔주면 되지 않을까..?
"""
...
def generate_launch_description():
    ...
    robot1 = {'name': 'turtle1', 'x_pose': '0.000753', 'y_pose': '-7.913351', 'z_pose': 0.01}
    robot2 = {'name': 'turtle2', 'x_pose': '7', 'y_pose': '0', 'z_pose': 0.01}
    robots = [
