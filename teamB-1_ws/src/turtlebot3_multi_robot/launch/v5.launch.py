...
"""
v4에서 바뀐점
1. 처음 spawn할때 틀봇1 앞을 보게, 틀봇2 맵 안쪽을 바라보게 지정
2. initail pose 세팅
========================
각각 rivz에서 마우스 클릭으로 목표 지정해주면 잘 감
"""
...
def generate_launch_description():
    ...
    for robot in robots:
        ...
        if robot['name'] == 'turtle1':
            yaw = 1.5708  # math.pi/2, 90도 (오른쪽으로 회전)
        elif robot['name'] == 'turtle2':
            yaw = 3.14159  # math.pi, 180도 회전
